...
namespace Word {
    ...
    public partial class dataDataSet : global::System.Data.DataSet {
        ...
        public partial class UserDataTable : global::System.Data.TypedTableBase<UserRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UserRow AddUserRow(string Surname, string FirstName, string SecondName) {
            ...
            public string SecondName {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'SecondName\' in table \'User\' is DBNull.", e);
                    }
                }
                set {
...
namespace Word.dataDataSetTableAdapters {
    ...
    public partial class UserTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `User` WHERE ((`ID` = ?) AND ((? = 1 AND `Surname` IS NULL) OR (`Surn" +
                "ame` = ?)) AND ((? = 1 AND `FirstName` IS NULL) OR (`FirstName` = ?)) AND ((? = " +
                "1 AND `SecondName` IS NULL) OR (`SecondName` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `User` (`Surname`, `FirstName`, `SecondName`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `User` SET `Surname` = ?, `FirstName` = ?, `SecondName` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `Surname` IS NULL) OR (`Surname` = ?)) AND ((? = 1 AND `FirstName` IS NULL) OR (`FirstName` = ?)) AND ((? = 1 AND `SecondName` IS NULL) OR (`SecondName` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Word.Properties.Settings.Default.dataConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Surname, FirstName, SecondName FROM [User]";
        ...
        public virtual int Delete(int Original_ID, string Original_Surname, string Original_FirstName, string Original_SecondName) {
        ...
        public virtual int Insert(string Surname, string FirstName, string SecondName) {
            if ((Surname == null)) {
        ...
        public virtual int Update(string Surname, string FirstName, string SecondName, int Original_ID, string Original_Surname, string Original_FirstName, string Original_SecondName) {
            if ((Surname == null)) {
