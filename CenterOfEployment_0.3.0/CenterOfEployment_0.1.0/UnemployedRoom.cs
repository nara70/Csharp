...
namespace CenterOfEployment_0._1._0
{
    public partial class UnemployedRoom : Form
    {
        ...
        {
            this.viewMessageForm = new ViewMessageForm();
            this.viewMessageForm.TopLevel = false;
            this.viewMessageForm.FormBorderStyle = FormBorderStyle.None;
            this.viewMessageForm.Dock = DockStyle.Fill;
            this.viewMessageForm.Visible = true;
            this.unemployed.ViewMessages(this.viewMessageForm.dataGridView, this.viewMessageForm.dataView);
            this.viewMessageForm.Controls.Add(this.viewMessageForm.dataGridView);
            //this.viewVacanciesForm.tableLayoutPanel.Controls.Add(this.viewVacanciesForm.dataGridView, 0, 0);
            this.panel3.Controls.Add(this.viewMessageForm);
            this.panel1.Controls.Remove(this.button1);
            this.panel2.Controls.Remove(this.button2);
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            {
                int id = Convert.ToInt16(this.viewVacanciesForm.dataGridView[0, this.viewVacanciesForm.dataGridView.CurrentCell.RowIndex].Value);
                string name = Convert.ToString(this.viewVacanciesForm.dataGridView[1, this.viewVacanciesForm.dataGridView.CurrentCell.RowIndex].Value);
                this.vacancyForm = new VacancyForm(this.unemployed, id, name);
                this.vacancyForm.requirements.Text = Convert.ToString(this.viewVacanciesForm.dataGridView[3, this.viewVacanciesForm.dataGridView.CurrentCell.RowIndex].Value);
                this.vacancyForm.company.Text = Convert.ToString(this.viewVacanciesForm.dataGridView[1, this.viewVacanciesForm.dataGridView.CurrentCell.RowIndex].Value);
                this.vacancyForm.profession.Text = Convert.ToString(this.viewVacanciesForm.dataGridView[2, this.viewVacanciesForm.dataGridView.CurrentCell.RowIndex].Value);
                this.vacancyForm.salary.Text = Convert.ToString(this.viewVacanciesForm.dataGridView[4, this.viewVacanciesForm.dataGridView.CurrentCell.RowIndex].Value);
        ...
        {
            this.panel3.Controls.Remove(this.viewMessageForm);
            this.panel1.Controls.Remove(this.button6);
            this.panel2.Controls.Remove(this.button7);
            this.panel1.Controls.Add(this.button1);
            this.panel2.Controls.Add(this.button2);
        }
    }
